...
let lvl_description = [
    ["Egyszerű ember vagy", "level00.jpg"],
    ["Szembekerülsz a rákszörnnyel és megver","level1.jpg"],
    ["Már két hónapja edzel","level2.jpg"],
    ["Egy fél éve csinálod az edzésterved, megkopaszodtál, és legyőzhetetlenné váltál", "level3.jpg"]
];
...
function fight(e_name, e_damage, e_life){
    story.innerHTML += "Edzés közben megtámadt egy " + e_name + "!<br>";
